...
You can give an order by uploading the gerber files, placement file, and bill-of-materials generated by the project files.
...
거버 파일, 부품 배치 파일, BOM(Bill of Materials)을 생성하고 업로드하여 바로 제작을 주문할 수 있습니다.
